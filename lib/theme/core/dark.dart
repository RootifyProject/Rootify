...
class AppDarkTheme {
  ...
  static ThemeData theme(Color accentColor, {ColorScheme? colorScheme}) {
    ...
    final textTheme = typography.white.apply(fontFamily: 'Inter');

    return ThemeData(
      brightness: Brightness.dark,
      primaryColor: effectiveColorScheme.primary,
      scaffoldBackgroundColor: effectiveColorScheme.surface,
      cardColor: effectiveColorScheme.surfaceContainer,
      useMaterial3: true,
      ...
      dividerTheme: DividerThemeData(
        color: effectiveColorScheme.outlineVariant.withValues(alpha: 0.2),
        thickness: 1,
        space: 24,
      ),
      cardTheme: CardThemeData(
        color: effectiveColorScheme.surfaceContainer.withValues(alpha: 0.7),
        elevation: 0,
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor:
            effectiveColorScheme.surfaceContainerLowest.withValues(alpha: 0.4),
        ...
        enabledBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
              color:
                  effectiveColorScheme.outlineVariant.withValues(alpha: 0.1)),
        ),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          elevation: 8,
          shadowColor: effectiveColorScheme.primary.withValues(alpha: 0.3),
          shape:
      ...
      switchTheme: SwitchThemeData(
        thumbColor: WidgetStateProperty.resolveWith((states) =>
            states.contains(WidgetState.selected)
                ? effectiveColorScheme.onPrimary
